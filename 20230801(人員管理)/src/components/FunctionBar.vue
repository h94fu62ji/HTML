...
<template>
    <div class="w-40 py-4 px-8 color4 rounded-xl">
        <div>
            ...
            <router-link to="/function/user-set" class="link2">基本設定</router-link>
            <router-link to="/function/leave" class="link2">請假申請</router-link>
            <router-link to="/function/data" class="link2">資料查詢</router-link>
        </div>
        <div class="pt-3">
